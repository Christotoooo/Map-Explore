...
//            }
            ...
            Collections.sort(list); // toString() should return a result in a certain order && group 5 also need it.
            for (String e : list) {
            	s += e; 
            }
            return s;
        ...
        public String toTxt() {
        	if (!(data instanceof TerrainCell)) {
        		return "";
        	}
        	TerrainCell tmp_cell = (TerrainCell)data;
        	String s = tmp_cell.getTerrain().toTxt() + " ";
        	if (tmp_cell.getTerrain() == TerrainType.kDefault) {
        		return "";
        	}
        	s += String.valueOf(tmp_cell.getHexX()) + " ";
        	s += String.valueOf(tmp_cell.getHexY()) + " ";
        	return s;
        }
    }
